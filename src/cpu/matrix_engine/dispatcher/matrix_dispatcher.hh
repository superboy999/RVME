...
public:
    ...
    void renameMatrixInst(RiscvISA::RiscvMatrixInst &minst, ScoreBoard_Entry* matrix_sbe, ThreadContext* tc = nullptr);
...
public:
    ...
    uint32_t loada, loadb, loadc, loadacommit, loadbcommit, loadccommit;
    ...
    statistics::Scalar AQread;
    statistics::Scalar AQwrite;
    statistics::Scalar MQread;
    statistics::Scalar MQwrite;

    statistics::Scalar testnum;
    statistics::Scalar matrix_load_inst;
    statistics::Scalar matrix_store_inst;
private:
    //python configuration;
    const uint32_t tileReg_num;
    const uint32_t accReg_num;
