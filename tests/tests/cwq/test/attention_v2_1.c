...
int main() {
    ...
    const char *base =
        "/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_inputs/";

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_inputs/input.txt",
    ...
    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/Q_buf.txt",
        Q_buf_cp, sizeof(acc_t), SEQ_LEN * HIDDEN_DIM);

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/K_buf.txt",
        K_buf_cp, sizeof(acc_t), SEQ_LEN * HIDDEN_DIM);

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/V_buf.txt",
        V_buf_cp, sizeof(acc_t), SEQ_LEN * HIDDEN_DIM);

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/attn_buf.txt",
        attn_buf_cp, sizeof(acc_t),
        NUM_HEADS * SEQ_LEN * SEQ_LEN);

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/softmax_attn_buf.txt",
        softmax_attn_buf_cp, sizeof(acc_t),
        NUM_HEADS * SEQ_LEN * SEQ_LEN);

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/out_buf.txt",
        out_buf_cp, sizeof(acc_t), SEQ_LEN * HIDDEN_DIM);

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/out_buf_acc.txt",
        out_buf_acc_cp, sizeof(acc_t), SEQ_LEN * HIDDEN_DIM);

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/resadd_out.txt",
        resadd_out_cp, sizeof(acc_t), SEQ_LEN * HIDDEN_DIM);

    read_tensor_txt("/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/0119/attn_outputs/out.txt",
