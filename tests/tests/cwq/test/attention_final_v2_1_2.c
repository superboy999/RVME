...
static alignas(CACHELINE_SIZE) elem_t Q_inR[SEQ_LEN][4*HIDDEN_DIM] = {[0 ... SEQ_LEN-1][0 ... 4*HIDDEN_DIM-1] = 1};
...
)
{
    ...
    dump_matrix_int8(fp, "Q_inR", Q_inR, SEQ_LEN, 4 * HIDDEN_DIM);
