...
static void tiled_norm_auto(const size_t dim_I, const size_t dim_J,
  ...
  printf("[INFO][SOFTMAX] max_tile_ij_in_bank_c = %d, tile_I = %d, tile_J = %d\n", 
  ...
  while (true) {
    ...
    if (is_spad_rows_satisfied(tile_I, tile_J + 1, 0, temp_size) &&
    ...
    if (is_spad_rows_satisfied(tile_I + 1, tile_J, 0, temp_size) &&
