...
# GENERAL OPTIONS
ps.add_option('--cmd',              type="string", default="/cluster/home/guoym/gem5_matrix_engine/o3_v0.6/tests/cwq/test/softmax_v2",
...
def connectMatrixCache(cpu, matrix_engine, l2bus):
    ...
    cpu.matrix_interface.matrix_engine.matrix_spm.dmaDevice.dmaPort = l2bus.cpu_side_ports
